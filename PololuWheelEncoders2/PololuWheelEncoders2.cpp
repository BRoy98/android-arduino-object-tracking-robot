...
{
	PololuWheelEncoders2::init(m1a,m1b,m2a,m2b);
}

extern "C" long encoders_get_counts_m1()
{
	return PololuWheelEncoders2::getCountsLeft();
}

extern "C" long encoders_get_counts_m2()
{
	return PololuWheelEncoders2::getCountsRight();
}

extern "C" long encoders_get_counts_and_reset_m1()
{
	return PololuWheelEncoders2::getCountsAndResetLeft();
}

extern "C" long encoders_get_counts_and_reset_m2()
{
	return PololuWheelEncoders2::getCountsAndResetRight();
}

extern "C" long encoders_check_error_m1()
{
	return PololuWheelEncoders2::checkErrorM1();
}

extern "C" long encoders_check_error_m2()
{
	return PololuWheelEncoders2::checkErrorM2();
}
...
void PololuWheelEncoders2::init(unsigned char m1a, unsigned char m1b, unsigned char m2a, unsigned char m2b)
{
	global_m1a = m1a;
	global_m1b = m1b;
	global_m2a = m2a;
...
long PololuWheelEncoders2::getCountsLeft()
{
	cli();
...
long PololuWheelEncoders2::getCountsRight()
{
	cli();
	long tmp = global_counts_m2;
	sei();
	return tmp;
}

long PololuWheelEncoders2::getCountsAndResetLeft()
{
	cli();
	long tmp = global_counts_m1;
	global_counts_m1 = 0;
...
long PololuWheelEncoders2::getCountsAndResetRight()
{
	cli();
	long tmp = global_counts_m2;
	global_counts_m2 = 0;
...
unsigned char PololuWheelEncoders2::checkErrorM1()
{
...
unsigned char PololuWheelEncoders2::checkErrorM2()
{
